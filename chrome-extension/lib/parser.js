...
- 長文の場合: 本文の中から最も具体的なイベント名を抽出して合成する（例: 「オンライン説明会」）
  - 「■開催日時」「■場所」「■参加対象」「■実施概要」等のセクション見出しはタイトルに含めない
  - 「本日の打ち合わせ」のような一般的すぎる表現は避け、固有名（プロジェクト名・サービス名等）を含める
...
- ✉️ 連絡/メール/返信
- 📦 その他（判断できない場合）
判断ルール: 仕事・業務に関するものは 💼、対面/オンライン問わず会議体は 🤝 を優先
...
【calendarKey ルール】
- "work": 仕事・業務に関する予定（会議/MTG/打ち合わせ/商談/面談/出張/営業/取引先/研修/セミナー/契約 など）
- "personal": プライベートの予定（通院/食事/買い物/旅行/趣味/運動/家族/友人 など）
- どちらとも判断できない真に曖昧な場合のみ "personal" にフォールバック（"work" への安易なデフォルト禁止）

【例1: event（日付あり・endTime 自動補完）】
入力: "明日の21時からジム"
出力: {"registration_type":"event","title":"🏃ジム","category":"🏃","date":"${tomorrowStr}","startTime":"21:00","endTime":"22:00","allDay":false,"calendarKey":"personal","location":"","meetUrl":null,"description":""}

【例2: event（時刻範囲ダッシュ）】
入力: "明日15:30‐16:30 新規提案MTG @本社会議室A"
出力: {"registration_type":"event","title":"💼新規提案MTG","category":"💼","date":"${tomorrowStr}","startTime":"15:30","endTime":"16:30","allDay":false,"calendarKey":"work","location":"本社会議室A","meetUrl":null,"description":""}

【例3: event（複数行・長文・Zoom付き・業務）】
入力: "■開催日時\\n6月16日（火）15:30‐16:30\\nZoom ミーティングに参加する\\nhttps://us02web.zoom.us/j/00000000000?pwd=EXAMPLEexampleEXAMPLEexample\\n■参加対象\\n対象システムを業務で利用する方\\n■実施概要\\n・データ項目説明\\n・本番稼働に向けたご案内\\n■備考\\n後日アーカイブ配信および資料展開予定"
出力: {"registration_type":"event","title":"💼オンライン説明会","category":"💼","date":"2026-06-16","startTime":"15:30","endTime":"16:30","allDay":false,"calendarKey":"work","location":"オンライン (Zoom)","meetUrl":"https://us02web.zoom.us/j/00000000000?pwd=EXAMPLEexampleEXAMPLEexample","description":"対象システムを業務で利用する方向けの説明会。後日アーカイブ配信予定。"}

【例4: event（Zoom・物理会場併催）】
入力: "2026年6月5日(金) 定例ミーティング終了後（おおよそ17:00頃～）\\n■場所\\n市民交流センター 2F会議室\\nおよびオンライン\\nZOOM https://us06web.zoom.us/j/00000000000\\nパスコード: 000000\\n打ち合わせ"
出力: {"registration_type":"event","title":"💼打ち合わせ","category":"💼","date":"2026-06-05","startTime":"17:00","endTime":"18:00","allDay":false,"calendarKey":"work","location":"市民交流センター 2F会議室","meetUrl":"https://us06web.zoom.us/j/00000000000","description":"定例ミーティング終了後（17:00頃）。オンライン同時開催。"}

【例5: event（時刻不明・終日）】
入力: "来週 ${nextWeekStr} 撮影"
出力: {"registration_type":"event","title":"📷撮影","category":"📷","date":"${nextWeekStr}","startTime":null,"endTime":null,"allDay":true,"calendarKey":"work","location":"","meetUrl":null,"description":""}`;
}
